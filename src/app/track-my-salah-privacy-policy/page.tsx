...
export const metadata: Metadata = {
    title: 'Track My Salah Privacy Policy',
    description: 'Privacy policy for the Track My Salah app.',
}

export default function TrackMySalahPrivacyPolicyPage() {
    return (
        <main className="fixed inset-0 overflow-y-auto bg-white text-black" aria-label="Track My Salah privacy policy">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Track My Salah, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Track My Salah.</p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: dev.ajx@proton.me</li>
            </ul>
            </article>
        </main>
    )
